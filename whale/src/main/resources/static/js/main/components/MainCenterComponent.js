const MainCenterComponent = {
	...
	data() {
		return {
			...
			dockIcons: ['static/images/main/streamingIcon.png','static/images/main/musicTemp.png','static/images/main/messageIcon.png','static/images/main/communityIcon.png','static/images/main/feedIcon.png'],
